...
Demandas na fase de Briefing/Imersão:
•	Apresentar demandas nessa fase
•	Apresentar cronograma de entrevistas
•	Solicitar aos pilotos a indicação dos profissionais de saúde (estabelecer 2 dias para envio);

Demandas na fase de Refinamento/Apresentação do protótipo final:
•	Apresentar demandas nessa fase
•	Informar a data da reunião de refinamento;

Demandas na fase de avaliação de release/Teste alfa:
•	Apresentar demandas nessa fase
•	Informar a data de liberação da versão alfa
•	Informar a data limite para retorno do formulário preenchido

Demandas na fase de Homologação:
•	Apresentar demandas nessa fase
•	Informar a data de liberação da versão para teste
•	Informar a data limite para retorno do parecer de homologação
...
Objetivo
Identificar informações relevantes para compreensão de problemas e dos usuários. É uma ferramenta de coleta de dados qualitativa e atitudinal, que permite obter dados válidos relevantes para a nossa pesquisa, seja para fazer descobertas ou validar informações que já possuímos.
...
Fonte: Metodologia b_thinking/Laboratório Bridge/UFSC
...
Mensalmente, ocorrerá reunião com os municípios pilotos para apresentação e discussão sobre as demandas em fase de protótipo final.
Os achados da discussão darão insumos para alterações no protótipo e continuidade no desenvolvimento da funcionalidade.
